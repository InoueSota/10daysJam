...
public class SmokeAParicle : MonoBehaviour
{
    ...
    public void Set(float popSpeed,float popAngle, float ras_, float gravity_, float startConTime_, float progressConTime_)
    {
        isPop = true;
